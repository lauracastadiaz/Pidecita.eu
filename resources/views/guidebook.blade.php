    ...
    <div class="container">
        ...
        <div class="row gx-5">
            <div class="col-lg-4 mb-5">
                <!-- Index Start -->
                <h2 class="small-title">Índice</h2>
                    ...
                    <div class="card mb-2">
                        <div class="card-body px-5 py-4">
                            ...
                            >
                                ...
                                <span class="flex-grow-1">Enfermedades Contagiosas</span>
                            </div>
                    ...
                    <div class="card mb-2">
                        <div class="card-body px-5 py-4">
                            ...
                            >
                                ...
                                <span class="flex-grow-1">Tratamientos</span>
                            </div>
                    ...
                    <div class="card mb-2">
                        <div class="card-body px-5 py-4">
                            ...
                            >
                                ...
                                <span class="flex-grow-1">Medicamentos</span>
                            </div>
                    ...
                    <div class="card mb-2">
                        <div class="card-body px-5 py-4">
                            ...
                            >
                                ...
                                <span class="flex-grow-1">Por Especialidad</span>
                            </div>
                    ...
                    <div class="card mb-2">
                        <div class="card-body px-5 py-4">
                            ...
                            >
                                ...
                                <span class="flex-grow-1">Ayuda a los Trabajadores</span>
                            </div>
                    ...
                    <div class="card mb-2">
                        <div class="card-body px-5 py-4">
                            ...
                            >
                                ...
                                <span class="flex-grow-1">Pautas de Tratamiento y Recursos</span>
                            </div>
                    ...
                    <div class="card mb-2">
                        <div class="card-body px-5 py-4">
                            ...
                            >
                                ...
                                <span class="flex-grow-1">Atención a las víctimas de delitos</span>
                            </div>
            ...
            <div class="col-lg-8">
                <!-- Details Start -->
                <h2 class="small-title">Facturación simplificada</h2>
                <div class="card">
                    <div class="card-body">
