...
@section('content')
    <div class="container">
        ...
        <div class="row g-4 mb-5"> <!--se van añadiendo las recetas que añada el médico al paciente -->
            <div class="col-md-6 col-xl-3">
                <div class="card h-100">
                    <div class="card-body d-flex flex-column justify-content-between">
                        <div>
                            <h3 class="heading text-primary mb-4">Prescripción 161-97-2030</h3>
                            <div class="mb-3">
                                <div class="text-muted text-small mb-1">NOMBRE</div>
                                <div>Joisse Kaycee</div>
                            </div>
                            <div class="mb-3">
                                <div class="text-muted text-small mb-1">FECHA</div>
                                <div>22.12.2021</div>
                            </div>
                            <div class="mb-3">
                                <div class="text-muted text-small mb-1">ESTADO</div>
                                <div>Active</div>
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="d-flex flex-row justify-content-between w-100 mt-3">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-primary btn-icon btn-icon-start w-100 me-2">
                                <i data-acorn-icon="health"></i>
                                <span>Info</span> <!--Consultar al médico -->
                            </button>
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card h-100">
                    <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        <div class="d-flex flex-row justify-content-between w-100 mt-3">
                            <button type="button" class="btn btn-sm btn-primary btn-icon btn-icon-start w-100 me-2 enabled " enabled> <!--Las que no estén activas las puede activar el médico -->
                                <i data-acorn-icon="health"></i>
                                <span>Refill</span>
                            </button>
                            <button type="button" class="btn btn-sm btn-outline-primary btn-icon btn-icon-start w-100 me-2 disabled" disabled>
