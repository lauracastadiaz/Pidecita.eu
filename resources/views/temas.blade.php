...
$title = 'Temas';
$description= 'Temas';
$breadcrumbs = ["/"=>"Aplicación","/temas"=>"Temas"]
@endphp
...
<div class="container">
    ...
    <div class="container modal-dialog modal-dialog-scrollable full" role="document" id="settings"
        aria-labelledby="settings" aria-hidden="false">
            ...
            <div class="modal-body">
                <div class="scroll-track-visible">
                    ...
                    <div class="mb-5" id="behaviour">
                        <label class="mb-3 d-inline-block form-label">Comportamiento del Menú</label>
                        <div class="row d-flex g-3 justify-content-between flex-wrap">
                ...
                <button class="btn btn-primary" type="submit" onclick="modificarTema()">Guardar</button> <!--definir funcion -->
            </div>
        </div>
    </div>
</div>
