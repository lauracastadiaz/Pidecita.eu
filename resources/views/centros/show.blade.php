...
<div class="container">
    ...
    <div class="card-body">
        <a href="{{ route('centros.index') }}"></a>
        <div class="col ">
            <a class="btn btn-sm btn-success" href="{{ route('centros.create') }}">Añadir Centro</a>
        </div>

        <div class="card-footer">
            <a href="{{ route('centros.edit', $centro->id) }}" class="btn btn-primary btn-sm">Editar</a>
