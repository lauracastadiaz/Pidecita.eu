...
@section('content')
    <div class="container">
        ...
        <div class="page-title-container">
            <div class="row">
                ...
                <div class="col-12 col-md-7">
                    <a href="/Appointments" class="muted-link pb-1 d-inline-block breadcrumb-back">
                        <i data-acorn-icon="chevron-left" data-acorn-size="13"></i>
                        <span class="text-small align-middle">Citas</span>
                    </a>
        ...
        <h2 class="small-title">Crear Cita</h2>
                ...
                <ul class="nav nav-tabs justify-content-center" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link text-center" href="#departmentTab" role="tab">
                            <div class="mb-1 title d-none d-sm-block">Especialidad</div>
                            <div class="text-small description d-none d-md-block">Elige una especialidad</div>
                        </a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link text-center" href="#doctorTab" role="tab">
                            <div class="mb-1 title d-none d-sm-block">Doctor</div>
                            <div class="text-small description d-none d-md-block">Elige un doctor</div>
                        </a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link text-center" href="#dateTab" role="tab">
                            <div class="mb-1 title d-none d-sm-block">Fecha</div>
                            <div class="text-small description d-none d-md-block">Selecciona una fecha</div>
                        </a>
                    </li>
            ...
            <div class="card-body pt-7">
                <div class="tab-content">
                    <div class="tab-pane fade sh-xl-60 text-center" id="departmentTab" role="tabpanel">
                        <h5 class="card-title">Elige una Especialidad para tu Cita</h5>
                        <p class="card-text text-alternate mb-4">Estas son las especialidades disponibles para tu centro.</p>
                        <div class="row g-2">
                  ...
                  <span class="card-body text-center">
                    ...
                    <div class="tab-pane fade sh-xl-60 text-center" id="doctorTab" role="tabpanel">
                        <h5 class="card-title">Elige un Doctor</h5>
                        <p class="card-text text-alternate mb-4">Estos son los médicos disponibles para tu centro.</p>
                        <div class="row g-2">
                    ...
                    <div class="tab-pane fade sh-xl-60 text-center" id="dateTab" role="tabpanel">
                        <h5 class="card-title">Selecciona una fecha</h5>
                        <p class="card-text text-alternate mb-4">Estas son las Fechas Disponibles para este Doctor.</p>
                    ...
                    <div class="tab-pane fade sh-xl-60" id="completeTab" role="tabpanel">
                        <div class="text-center d-flex flex-column justify-content-center align-items-center h-100">
                            ...
                            <p class="card-text text-alternate mb-4">Su cita ha sido creada correctamente.</p>
