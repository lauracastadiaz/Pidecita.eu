...
$breadcrumbs = ["Dashboards/Dashboards" => "Inicio", "/Appointments" => "Citas"]
@endphp
...
@section('content')
    <div class="container">
        ...
        <h2 class="small-title">Citas activas</h2>
        ...
        <!-- Quick Links Start -->
        <div class="mb-5">
            <h2 class="small-title">Atajos</h2>
                        ...
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <div class="d-flex flex-column sh-5">
                                    <a href="/Appointments/New" class="heading stretched-link">Nueva Cita</a>
                                </div>
                            </div>
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <div class="d-flex flex-column sh-5">
                                    <a href="/Consult" class="heading stretched-link">Consulta Online</a>
                                </div>
                            </div>
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <div class="d-flex flex-column sh-5">
                                    <a href="/reseña" class="heading stretched-link">Escribe una Reseña</a>
                                </div>
                            </div>
                            <div class="text-muted text-center">
