    ...
    <div class="container">
        ...
        <div class="page-title-container">
            <div class="row">
                ...
                <div class="col-12 col-md-7">
                    <a href="/Results" class="muted-link pb-1 d-inline-block breadcrumb-back">
                        <i data-acorn-icon="chevron-left" data-acorn-size="13"></i>
                        <span class="text-small align-middle">Resultados</span>
                    </a>
        ...
        <div class="row gx-5 gy-5">
            <div class="col-12 col-xl-4">
                ...
                <div class="card">
                    <div class="card-body mb-n5">
                        ...
                        <div class="mb-5">
                            <div>
                                <p class="text-small text-muted mb-2">PACIENTE</p>
                                ...
                                <div class="row g-0 mb-2">
                                    ...
                                    <div class="col text-alternate">Mujer</div>
                                </div>
                                <div class="row g-0 mb-2">
                                    <div class="col-auto">
                                        <div class="sw-3 me-1">
            ...
            <div class="col-12 col-lg-8">
                <!-- Hematology Start -->
                <h2 class="small-title">Hematología</h2>
                <div class="card mb-5">
                    <div class="card-body">
                        <div class="row g-0 h-100 align-content-center mb-4 d-none d-md-flex">
                            ...
                            <div class="col-6 col-md-2 d-flex align-items-center text-alternate text-medium text-muted text-small">RESULTADO</div>
                            <div class="col-6 col-md-2 d-flex align-items-center text-alternate text-medium text-muted text-small">PRE</div>
                            <div class="col-6 col-md-2 d-flex align-items-center text-alternate text-medium text-muted text-small">REFERENCIA</div>
                            <div class="col-6 col-md-2 d-flex align-items-center text-alternate text-medium text-muted text-small justify-content-end">ESTADO</div>
                        </div>
                ...
                <!-- Hormones Start -->
                <h2 class="small-title">Hormonas</h2>
                <div class="card mb-5">
                    <div class="card-body">
                        <div class="row g-0 h-100 align-content-center mb-4 d-none d-md-flex">
                            <div class="col-12 col-md-4 d-flex align-items-center mb-2 mb-md-0 text-muted text-small">TEST</div>
