<div class="nav-content d-flex">
    ...
    <div class="user-container d-flex">
        <a href="#" class="d-flex user position-relative" data-bs-toggle="dropdown" aria-haspopup="true"
            aria-expanded="false">
            <img class="profile" alt="{{ Auth::user()->name }}" src="/img/profile/profile-8.webp" />
        ...
        <ul id="menu" class="menu">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/contacto">
                    ...
                    <span class="label">{{__('Contacto')}}</span></a>
            </li>
            <!-- <li>
                <a href="#">
        ...
        <ul id="menu" class="menu list-unstyled list-inline text-center menu-icons ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('login') }}">
                    ...
                    <span class="label">{{__('Iniciar Sesión')}}</span>
                </a>
            </li>
            @endif
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('register') }}">
                    ...
                    <span class="label">{{__('Registrarse')}}</span>
                </a>
            </li>
            @endif
            @else
            <li class="nav-item">
                <a class="nav-link" href="/Dashboards">
                    <i data-acorn-icon="appointment" class="icon" data-acorn-size="18"></i>
                    <span class="label">{{__('Aplicación')}}</span>
                </a>
            </li>
