...
@section('content_right')
    <div class="sw-lg-70 min-h-100 bg-foreground d-flex justify-content-center align-items-center shadow-deep py-5 full-page-content-right-border">
        <div class="sw-lg-50 px-5">
            ...
            <div class="mb-5">
                <h2 class="cta-1 mb-0 text-primary">¿Ha olvidado su contraseña?</h2>
                <h2 class="cta-1 text-primary">¡Restaurela aquí!</h2>
            </div>
            <div class="mb-5">
                <p class="h6">Por favor, introduzca su email para restaurar su contraseña.</p>
                <p class="h6">
                    Si ya eres miembro
