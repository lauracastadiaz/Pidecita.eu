...
@section('content')
    <div class="container">
        ...
        <div class="page-title-container">
            <div class="row">
                ...
                <div class="col-12 col-md-7">
                    ...
                    <h1 class="mb-0 pb-0 display-4" id="title">¡Bienvenido, {{ Auth::user()->name }}!</h1> 
                </div>
                <!-- Title End -->
            </div>
        </div>
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            <div class="text-center">
                                <p class="text-small text-muted mb-1">GRUPO SANGUINEO</p>
                                <p>A+</p>
                            </div>
                            <div class="text-center">
                        ...
                        <div class="mb-5">
                            <p class="text-small text-muted mb-2">DIAGNÓSTICO</p>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="row g-0 mb-2">
                                ...
                                <div class="col text-alternate">{{ Auth::user()->email }}</div>
                            </div>
                            <div class="row g-0 mb-2">
                                <div class="col-auto">
                                    <div class="sw-3 me-1">
                        ...
                        <div>
                            <p class="text-small text-muted mb-2">NOTAS</p>
                            <div class="row g-0">
                                <div class="col-auto">
                                    <div class="sw-3 me-1">
            ...
            <div class="col-xl-8">
                ...
                <div class="row">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade" id="dayNone" role="tabpanel">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <p>No appointments for the day!</p> <!-- si no hay cita ese día -->
                                            <button class="btn btn-icon btn-icon-start btn-primary" type="button">
                                                <i data-acorn-icon="calendar"></i>
                                                <span>Nueva Cita</span> <!--redirigir a sección de agregar cita -->
                                            </button>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <!-- Your Doctors Start -->
                    <div class="col-xl-6 mb-5">
                        <h2 class="small-title">Tus Doctores</h2> <!--según doctores haya en la bbdd se van poniendo aquí -->
                        <div class="card">
                                    ...
                                    <div class="row g-0 sh-6">
                                        ...
                                        <div class="col">
                                            <div class="card-body d-flex flex-row pt-0 pb-0 ps-3 pe-0 h-100 align-items-center justify-content-between">
                                                <div class="d-flex flex-column">
                                                    <a href="/Doctors/Detail" class="body-link">Karter Kidd, M.D.</a> <!--al pulsar ver la información del doctor (su perfil) -->
                                                    <div class="text-small text-muted">Neurologist</div>
                                                </div>
                                                <div class="d-flex">
                                                    <button class="btn btn-outline-secondary btn-sm ms-1" type="button">Agenda</button> <!--al pulsar ver el calendario de citas del doctor -->
                                    ...
                                    <div class="row g-0 sh-6">
                                        ...
                                        <div class="col">
                                            <div class="card-body d-flex flex-row pt-0 pb-0 ps-3 pe-0 h-100 align-items-center justify-content-between">
                                                ...
                                                <div class="d-flex">
                                                    <button class="btn btn-outline-secondary btn-sm ms-1" type="button">Agenda</button>
                                                    <button class="btn btn-sm btn-icon btn-icon-only btn-outline-secondary ms-1" type="button">
                                                        <i data-acorn-icon="more-vertical"></i>
                                                    </button>
                                                </div>
        ...
        <div class="row">
            <!-- Results Start -->
            <div class="col-xl-6 mb-5">
                <h2 class="small-title">Resultados</h2>
                        ...
                        <div class="row g-0 h-100 align-content-center">
                            <div class="col-11 col-md-7 d-flex align-items-center mb-1 mb-md-0 order-1 order-md-1">
                                <a href="/Results/Detail" class="body-link text-truncate">
                                    ...
                                    <span class="align-middle">blood-analysis.pdf</span> <!--Los resultados de algo de la persona estarán subidos aquí para descargar -->
                                </a>
                            </div>
            ...
            <!-- Check Up Start -->
            <div class="col-xl-6 mb-5">
                <h2 class="small-title">Examinar</h2>
                <div class="card w-100 sh-100 h-xl-100-card hover-img-scale-up position-relative">
                    ...
                    <div class="card-img-overlay d-flex flex-column justify-content-between bg-transparent">
                        <div>
                            <div class="cta-2 mb-0 text-black w-75 w-sm-50">Pruébalo</div>
                            <div class="cta-2 mb-3 text-black w-75 w-sm-50">con un 30% de descuento</div>
