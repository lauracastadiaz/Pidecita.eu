    ...
    <div class="container">
        ...
        <div class="row gx-5">
            <div class="col-xl-4">
                        ...
                        <div class="mb-4 d-flex align-items-center flex-column">
                            ...
                            <div class="mb-3">
                                <div class="br-wrapper br-theme-cs-icon d-inline-block">
                                    <select class="rating" name="rating" autocomplete="off" data-readonly="false" data-initial-rating="5">
                            ...
                            <div class="d-flex flex-row justify-content-between w-100 w-sm-50 w-xl-100">
                                <button type="button" class="btn btn-primary w-100 me-2">Cita</button>
                                <button type="button" class="btn btn-outline-primary me-2">Reseña</button>
                ...
                <h2 class="small-title">Subespecialidades</h2>
                <div class="card mb-5">
                    <div class="card-body">
                ...
                <h2 class="small-title">Premios</h2>
                <div class="card mb-5">
            ...
            <div class="col-xl-8">
                <!-- Experience Start -->
                <h2 class="small-title">Experiencia</h2>
                <div class="card mb-5">
                    <div class="card-body">
                        <div class="row g-0">
                ...
                <div class="d-flex justify-content-between">
                    <h2 class="small-title">Reseñas</h2>
                ...
                <!-- Publications Start -->
                <h2 class="small-title">Publicaciones</h2>
                <div class="card">
                    <div class="card-body mb-n3">
