    ...
    <div class="card-body">
        ...
        <form action="{{ route('medicos.update', $medico->id) }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="nif" class="form-control" id="nif" name="nif" value="{{ $medico->nif }}" required>
            </div>
            <div class="mb-3">
                <label for="direccion" class="form-label">Dirección</label>
                <input type="direccion" class="form-control" id="direccion" name="direccion"
                    value="{{ $medico->direccion }}" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select class="form-control" id="centro_id" name="centros[]" multiple>
                    ...
                    <option value="{{ $centro->id }}" {{ $medico -> centros->contains($centro->id) ? 'selected' : '' }}>
                        {{ $centro->nombre }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="mb-3">
                ...
                <table id="horariosProfesional" class="table table-caption">
                    ...
                    <tbody>
                        ...
                        as $dia)
                        @php
                        $horarioDia = $medico->horarioProfesional->$dia ?? ['de' => ['00:00'], 'a' => ['00:00']];
                        @endphp
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="mb-3">
                                    <select class="form-control" id="centro_id" name="centros[]">
                                        @foreach (\App\Models\Centro::all() as $centro)
                            ...
                            <td class="p-2">
                                <div class="form-check form-switch">
                                    ...
                                    <input class="form-check-input" type="checkbox"
                                        name="descanso_{{ strtolower($dia) }}" id="descanso_{{ strtolower($dia) }}"
                                        value="1"
                                        {{ in_array(strtolower($dia), $medico->horarioProfesional->dias_descanso ?? []) ? 'checked' : '' }}>
                        ...
                        <tr>
                            <td colspan="7" class="p-2">
                                ...
                                <input type="text" id="diasNoDisponibles" class="form-control mb-3"
                                    ...
                                    value="{{ $medico->horarioProfesional ? implode(', ', $centro->horarioProfesional->fechas_no_disponibles) : '' }}">
                            </td>
                        ...
                        <tr>
                            <td colspan="7" class="p-2">
                                ...
                                <input type="text" id="diasExcepcionales" class="form-control mb-3"
                                    ...
                                    value="{{ $medico->horarioProfesional ? implode(', ', $medico->horarioProfesional->fechas_excepcionales) : '' }}">
                            </td>
                        </tr>
