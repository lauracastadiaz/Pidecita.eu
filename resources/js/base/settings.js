 ...
 *
 *  responsable de modificar y aplicar las configuraciones del tema en el sitio web
 * 
 ...
 * @param {string} storagePrefix         Local storage key. clave de almacenamiento local para guardar las configuraciones.
 * @param {boolean} showSettings         Hides settings button and panel when set to false. Booleano que controla si se muestra el botón y el panel de configuraciones.
 * @param {boolean} carryParams          Modifies anchor tag clicks and carries parameters from the current url to the new one. It's basicly for showing colors via an anchor. Booleano que modifica los clics en los enlaces de anclaje y lleva los parámetros de la URL actual a la nueva.
 *
 * @method updateAttribute               Receives an id, value and updates the attribute en las configuraciones del tema.
 * @method getAttribute                  Receives an id and returns attribute en las configuraciones del tema.
 *
 * @event Globals.menuPlacementChange    Fired when placement value changes. Carries value in detail variable.  Evento que se dispara cuando cambia el valor de la ubicación del menú.
 * @event Globals.menuBehaviourChange    Fired when behaviour value changes. Carries value in detail variable.  Evento que se dispara cuando cambia el valor del comportamiento del menú.
 * @event Globals.colorAttributeChange   Fired when color value changes. Carries value in detail variable. Evento que se dispara cuando cambia el valor del color del tema.
 * @event Globals.borderRadiusChange     Fired when border radius changes. Carries value in detail variable. Evento que se dispara cuando cambia el valor del radio de borde.
 * @event Globals.layoutChange           Fired when layout value changes to boxed or fluid.  Evento que se dispara cuando cambia el valor del diseño a "boxed" o "fluid".
 *
 *
 */
