 ...
 *
 *  proporciona funcionalidades para conectar un botón "check all" a elementos que contienen casillas de verificación
 * 
 *  tiene métodos internos para manejar eventos y realizar operaciones relacionadas con el estado 
 *  de las casillas de verificación, como marcar todas las casillas, desmarcar todas las casillas, 
 *  controlar el estado de la casilla "check all", y manejar los clics en casillas individuales.
 * 
...
class Checkall {
  get options() {
    return {
      itemSelector: '.card', //  Selector CSS para identificar los elementos dentro del contenedor que deben ser controlados por las casillas de verificación.
      clickSelector: '.card', // Selector CSS para identificar el contenido dentro de los elementos que se pueden hacer clic y que pueden afectar al estado de las casillas de verificación.
      selectedClass: 'selected', //  Clase CSS que se agrega a los elementos seleccionados.
    };
  }
  ...
  // Actualiza los listeners para proporcionar una manera de actualizar.
  update() {
