...
<div
    ...
    <div class="sw-lg-50 px-5">
        ...
        <div class="mb-5">
            ...
            <p class="h6">
                Click <a href="<?php echo e(route('login')); ?>">here</a> to login and start using the application.
            </p>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout_full', ['title' => $title, 'description' => $description], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/pidecita.eu/httpdocs/resources/views/auth/registration_success.blade.php ENDPATH**/ ?>