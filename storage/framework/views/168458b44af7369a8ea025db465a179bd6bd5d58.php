...
<div id="root">
    ...
    data-<?php echo e($key); ?>="<?php echo e($value); ?>"
        ...
        <?php endif; ?>
    >
        <?php echo $__env->make('_layout.nav_home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    <main>
...
<?php /**PATH /var/www/vhosts/pidecita.eu/httpdocs/resources/views/layout_home.blade.php ENDPATH**/ ?>